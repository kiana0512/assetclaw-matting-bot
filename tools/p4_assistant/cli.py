...
def main(argv: list[str] | None = None) -> int:
    ...
    one = _add_common(sub.add_parser("shelve-ui-import"))
    ...
    try:
        if args.command == "ask":
            ...
            payload = ops.create_changelist(args.workflow, args.workspace, args.desc)
        elif args.command == "reconcile":
            payload = ops.reconcile_changelist(args.workflow, args.workspace, args.cl, allow_delete=args.allow_delete)
        elif args.command == "shelve":
            payload = ops.shelve_changelist(args.workflow, args.workspace, args.cl, force=args.force, allow_delete=args.allow_delete)
        elif args.command == "report":
            payload = ops.generate_report(args.workflow, args.workspace, args.cl, allow_delete=args.allow_delete)
